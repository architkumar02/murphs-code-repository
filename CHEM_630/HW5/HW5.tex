...
\iso[123][50]{Sn} & Even Z with W-A = 4 indicating instability, but Sn has 10 stable isotopes &  Stable & $\beta^{-}$: 100.00\% \\
\iso[66][31]{Ga} & Odd Z with W-A = -4 indicating instability with an abundance of neutrons probably $\beta^{-}$ &  $\beta^{-}$ & $\beta^{+}$: 100.00\% \\
\iso[185][76]{Os} & Even Z with W-A = -5 indicating instability with an abundance of neutrons, but probably alpha decay and not beta due to being so far from stability &  $\alpha$ & $\beta^{+}$: 100.00\%\\
...
See the Advanced Topic section for more details.
