...
:Detector(Det)
{ 
  rangesimDir = new G4UIdirectory("/testem/");
  rangesimDir->SetGuidance("commands specific to this example");
  
  detDir = new G4UIdirectory("/rangesim/det/");
  detDir->SetGuidance("detector construction commands");
        
  MaterCmd = new G4UIcmdWithAString("/rangesim/det/setMat",this);
  ...
  SizeCmd = new G4UIcmdWithADoubleAndUnit("/rangesim/det/setSize",this);
  ...
  MagFieldCmd = new G4UIcmdWithADoubleAndUnit("/rangesim/det/setField",this);  
  ...
  UpdateCmd = new G4UIcmdWithoutParameter("/rangesim/det/update",this);
