...
\begin{figure}
  ...
  \caption[Simulated Average Gamma Energy Deposition]{Simulated average energy depsotion from a \iso[60]{Co} source for various thickness and carborane concentations.  The solid line is the $\mu_{en}$ energy depostion for a similar material from the NIST X-ray mass attentuation dataset.}
