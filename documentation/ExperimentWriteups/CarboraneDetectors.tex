...
The neutron performance of these detectors is shown in \autoref{fig:NeutronSpectra}, while the gamma from \iso[60]{Co} is shown in \autoref{fig:LYGamma}.
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{MSCarborane_Co60}
  \caption[Gamma Response of Carborane Samples]{Gamma (\iso[60]{Co}) response of selected methylstyrene boron loaded scintillators.  Note that in both cases the light yield is diminished as additional boron is added.}
  \label{fig:LYGamma}
\end{figure}
\begin{figure}
  \centering
