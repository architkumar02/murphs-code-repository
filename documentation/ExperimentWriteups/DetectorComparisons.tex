...
Under this framework it is then possible to develop a mathematical lower level discriminator (MLLD) to function as this pulse height discriminator, and to then formulate the sensitivity requirement as the gamma intrinsic efficiency as a function of MLLD.
...
\begin{figure}
  ...
  \caption[Measured Light Yield (Guerard)]{Light yield as measured by Guerard. The GS20 measurement has a lower gamma performance than as measured, and the LiF:ZnS \iso[60]{Co} spectra does not have the same shape as we measured}
...
The EJ-426 has the lowest response, and it is not clear if the tail of the spectra is actually counts or background.
