...
\label{tab:PhysicalProperties}
  ...
  \toprule
    ...
    Post processed Composite PEN Film (12 Apr)& \iso[6]{Li} & $\approx$ \SI{250}{\um} & 28.1 \\
...
\begin{table}
  ...
  \begin{tabular}{c| c c |c c}
    ...
    Post processed Composite PEN (12 Apr)&	87.63	&	1,900	&	160.07	&	1,900	\\
    Post processed Composite PEN (22 Mar)&	&		&		&		\\
    PS Film & & & & \\
    \bottomrule
  \end{tabular}
\end{table}
...
\centering
  ...
  Post processed Composite PEN, $\approx$ \SI{250}{\um} (12 Apr)	&	209	&	1.96	\\
  Post processed Composite PEN $\approx$ \SI{212}{\um} (22 Mar)&	322	&	227	&	7.60	&	5.35	\\
