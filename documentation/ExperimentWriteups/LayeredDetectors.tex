...
\subsection{Light Yield Performance}
The light yield of the layered detectors was tested by comparing \SI{100}{\um} films cast unto UVT acrylic slabs.
The slabs were then layered in the following configurations, depending on the coupling to the PMT.
\begin{itemize}
  \item Rectangular PMT Coupling - The ordering of the layers is an \SI{18}{\mm} PMMA slab, a detector mounted on a \SI{6.35}{\mm} UVT slab, another \SI{18}{\mm} PMMA slab, and a second detector mounted on a \SI{6.35}{\mm} UVT slab.
  \item Fishtail light guide PMT Coupling - The ordering of the layers is an \SI{18}{\mm} PMMA slab, a detector mounted on a \SI{6.35}{\mm} UVT slab, another \SI{18}{\mm} PMMA slab, a second detector mounted on a \SI{6.35}{\mm} UVT slab, and a \SI{9}{\mm} UVT slab.
\end{item}
