...
The following films, \autoref{tab:1MMPMMAFilms}, are cast upon a \SI{1}{\mm} PMMA disc, and as shown above their neutron performance measurement is suspect.
The neturon spectra of some of these films are plotted in \autoref{fig:1MMFilmsNetCf252}
