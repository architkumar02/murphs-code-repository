...
\lstinputlisting[caption=Point Source Input Deck,label=lst:PointSrcScript]{PointSource/SCRIPT.mcnp}
\lstinputlisting[caption=Cf-252 Source Input Deck,label=lst:Cf252SrcScript]{Cf252Source/SCRIPT.mcnp}
...
\lstinputlisting[language=bash,caption=Point Source Run Script,label=lst:PointSrcRUNDATA]{PointSource/RUNDATA.sh}
\lstinputlisting[language=bash,caption=Cf-252 Source Run Script,label=lst:Cf252SrcRUNDATA]{Cf252Source/RUNDATA.sh}
\lstinputlisting[language=bash,caption=Queue Run,label=lst:QueueRun]{PointSource/queueRunScript.sh}
