...
\end{itemize}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{SingleFilm_DetectorAssembly.eps}
...
\begin{column}{0.45\textwidth}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{WattFission.eps}
...
\begin{frame}{Single layer optimization}
	...
	\begin{figure}
		\centering
		\includegraphics[height=0.5\textheight]{PS_50um_30LiF-InteractionRate-ShieldThickness.eps}
...
\begin{column}{0.45\textwidth}
	...
	\begin{figure}
		\centering
		\includegraphics[height=0.6\textheight]{EJ426HD_LayeredDetector_MultiSheet.eps}
	\end{figure}
\end{column}
\begin{column}{0.45\textwidth}
	\tiny
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{EJ426HD_LayeredDetector_SingleSheet.eps}
	\end{figure}
\end{column}
\end{columns}
\end{frame}
...
Observe an increased neutron count rate \dots
	\begin{figure}
		\centering
		\includegraphics[height=0.6\textheight]{EJ426HD_Multi_NeutronComparison.eps}
...
\begin{column}{0.45\textwidth}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{EJ426HD_Multi_GammaComparison.eps}
...
\begin{column}{0.45\textwidth}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{EJ426HD_Multi_GammaIntEff.eps}
...
\begin{frame}{Minimum Number of Films}
	...
	\begin{figure}
		\centering
		\includegraphics[height=0.6\textheight]{OptimalDetectorSize.eps}
