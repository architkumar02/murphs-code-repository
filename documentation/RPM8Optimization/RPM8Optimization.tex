...
The envisioned detector design consits of layers of \iso{6}[Li] neutron absorbing sheets sandwiched between layers of a thin light guide (less than \SI{5}{\milli \meter}).
