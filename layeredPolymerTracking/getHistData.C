void showTuple(const int run, const char* dirname="outputs",const char *ext=".root")
{
	...
	TFile* f1 = new TFile("run_1.root","r");
	TFile* f2 = new TFile("run_2.root","r");
	TFile* f3 = new TFile("run_3.root","r");
	TFile* f4 = new TFile("run_4.root","r");
	TFile* f5 = new TFile("run_5.root","r");
	TFile* f6 = new TFile("run_6.root","r");
	TFile* f7 = new TFile("run_7.root","r");
	TFile* f8 = new TFile("run_8.root","r");
