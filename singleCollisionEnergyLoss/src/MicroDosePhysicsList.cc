...
MicroDosePhysicsList::MicroDosePhysicsList():  G4VUserPhysicsList()
{
...
MicroDosePhysicsList::~MicroDosePhysicsList()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void MicroDosePhysicsList::ConstructParticle()
{
  ConstructBosons();
  ConstructLeptons();
  ConstructBarions();
...
void MicroDosePhysicsList::ConstructBosons()
{ 
  // gamma
...
void MicroDosePhysicsList::ConstructLeptons()
{
  // leptons
...
void MicroDosePhysicsList::ConstructBarions()
{
  //  baryons
...
void MicroDosePhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructGeneral();
...
void MicroDosePhysicsList::ConstructEM()
{
...
void MicroDosePhysicsList::ConstructGeneral()
{ }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void MicroDosePhysicsList::SetCuts()
{
  if (verboseLevel >0)
  {
    G4cout << "MicroDosePhysicsList::SetCuts:";
